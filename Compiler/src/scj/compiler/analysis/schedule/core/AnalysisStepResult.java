 ...
 * @param <SM>
 */
public class AnalysisStepResult<Instance, TV, SM extends TaskScheduleManager<TV>> {
	...
	public AnalysisStepResult(ParallelTasksResult<Instance, TV, SM> a, FormalParameterResult<Instance, TV, SM> b) {
