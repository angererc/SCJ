...
public class Elevator {
	...
	public void scjTask_doButtonPresses(Task<Void> now) {
		// First tick is 1
		int time = 1;
	...
	public void scjMainTask_begin(Task<Void> now) {
		...
		for (int i = 0; i < numLifts; i++) {
			...
			lift.scjTask_begin(new Task<Void>());
		}
		
		this.scjTask_doButtonPresses(new Task<Void>());
	}
	...
	public static void main(String args[]) {
		...
		building.scjMainTask_begin(new Task<Void>());
	}
}
