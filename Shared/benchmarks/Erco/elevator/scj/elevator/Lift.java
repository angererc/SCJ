...
public class Lift {
	...
	public void scjTask_begin(Task<Void> now) {
		this.scjTask_nextRound(new Task<Void>());
	}
	...
	// move between floors.
	public void scjTask_nextRound(Task<Void> now) {		
		Task<Void> nextRoundTask = new Task<Void>();
		this.scjTask_nextRound(nextRoundTask);
		if (travelDir == IDLE) {
			try {
				Thread.sleep(100);
			} catch (InterruptedException e) {
			}
			Task<Void> idleTask = new Task<Void>();
			this.scjTask_doIdle(idleTask);
			...
			Task<Void> movingTask = new Task<Void>();
			this.scjTask_doMoving(movingTask);
	...
	public void scjTask_doIdle(Task<Void> now) {
	...
	public void scjTask_doMoving(Task<Void> now) {
