...
public class SCJDelaunaytriangulation {
	...
	public static void main(String[] args) {
		...
		run = 0;
		SCJDelaunaytriangulation dt = new SCJDelaunaytriangulation();
	...
	public long run(String args[]) {
		...
		if (isFirstRun) {
			...
			System.err.println();
			System.err.println("application: Delaunay Triangulation (SCJ version)");
		...
		IndexedGraph<Element> mesh = triangulate(tuples);
	...
	private IndexedGraph<Element> triangulate(Collection<Tuple> tuples) {
