...
public class OrderedGaloisSCJComputation<T> extends GaloisSCJComputation<T> {
	...
	public OrderedGaloisSCJComputation(Mappable<T> initial, Rule priority) throws ExecutionException {
		this(initial, GaloisRuntime.getRuntime().getMaxThreads(), priority);
	}
	
	@SuppressWarnings("unchecked")
	public OrderedGaloisSCJComputation(Mappable<T> initial, int numTasks, Rule priority) throws ExecutionException {
